...
const wrapProxy = (proxyObject) => new Proxy(proxyObject, {
...
class I18nServiceRoot {
    constructor(baseLocale = '', getTranslationForLocale = () => ({}), initFormatters = () => ({})) {
        ...
        this._LL = wrapProxy(getFallbackProxy());
    }
    ...
    async setLocale(newLocale) {
        ...
        this._LL = wrapProxy(i18nObject(newLocale, translation instanceof Promise ? await translation : translation, formatters instanceof Promise ? await formatters : formatters));
